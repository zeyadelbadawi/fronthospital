...
const PatientPlanEditor = () => {
  ...
  const fetchExistingPlan = async () => {
    try {
      const response = await axiosInstance.get(`${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapyS/plan/${patientId}`)
    ...
    <div className={styles.planEditorContainer}>
      <div className={styles.planEditorCard}>
              ...
              <div className={styles.studentInfo}>
                <h1 className={styles.planTitle}>
                  <Brain className={styles.titleIcon} />
                   Single Session Occupational Therapy
                </h1>
        ...
        <SyncfusionDocxCase
                            ...
                            planEndpoint={`${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapyS/upload-plan`}
                          />
            </div>
