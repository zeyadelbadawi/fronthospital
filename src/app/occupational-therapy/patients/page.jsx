  ...
  const fetchOccupationalTherapyPatients = async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `/OccupationalTherapy/Occupational-therapy-assignments?page=${currentPage}&search=${search}`,
      )
      ...
      console.error("Error fetching Occupational therapy patients:", error)
      setAssignments([])
    } finally {
      setLoading(false)
    }
    ...
    <div className="card h-100 p-0 radius-12">
      <div className="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center flex-wrap gap-3 justify-content-between">
        <div className="d-flex align-items-center flex-wrap gap-3">
          <h6 className="text-lg mb-0">Occupational Therapy Department Patients</h6>
        ...
        <button
          onClick={() => router.push("/occupational-therapy/assign-patients")}
      ...
      <div className="card-body p-24">
        {loading ? (
          ...
          <div className="text-center py-4">
            <p className="text-muted">No patients assigned to Occupational therapy</p>
            <button onClick={() => router.push("/occupational-therapy/assign-patients")} className="btn btn-primary mt-2">
              Assign Patients
            </button>
          </div>
        ) : (
                  ...
                  <tr key={assignment._id || index}>
                    ...
                    <td className="text-center">
                      <div className="d-flex align-items-center gap-10 justify-content-center">
                        <button
                          onClick={() => router.push(`/occupational-therapy/plan/${assignment.patient?._id}`)}
                          type="button"
                        ...
                        <button
                          onClick={() => router.push(`/occupational-therapy/test/${assignment.patient?._id}`)}
                          type="button"
        ...
        <div className="d-flex align-items-center justify-content-between flex-wrap gap-2 mt-24">
          <span className="text-gray-900">Showing {assignments.length} Occupational therapy department patients</span>
