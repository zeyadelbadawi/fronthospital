  ...
  const fetchphysicalTherapyPatients = async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/physicalTherapyS/physical-therapy-assignments?page=${currentPage}&search=${search}`,
      )
        ...
        <div className={styles.cardHeader}>
          <div className={styles.headerContent}>
            <div className={styles.headerLeft}>
              ...
              <h2 className={styles.pageTitle}>Single Sessions physical Therapy Students</h2>
            </div>
        ...
        <div className={styles.cardBody}>
          {loading ? (
            <div className={styles.loadingContainer}>
              ...
              <p className={styles.loadingText}>Loading physical Therapy patients...</p>
            </div>
                    ...
                    <tr key={assignment._id || index} className={styles.tableRow}>
                      ...
                      <td className={styles.actionsCell}>
                        <div className={styles.actionButtons}>
                          <button
                          onClick={() => router.push(`/physical-therapyS/plan/${assignment.patient?._id}`)}
