...
const AllPatientsPhysicalTherapy = () => {
  ...
  const fetchPhysicalTherapyPatients = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/physicalTherapyS/physical-therapy-assignments?${params}`,
      )
  ...
  const handleCompleteAssignment = async () => {
    ...
    try {
      const response = await axiosInstance.put(
        `${process.env.NEXT_PUBLIC_API_URL}/physicalTherapyS/complete-assignment/${completeModal.assignment._id}`,
  ...
  const handlePlanClick = (patientId) => {
    router.push(`/physical-therapyS/plan/${patientId}`)
  }
    ...
    <div className={styles.upcomingContainer}>
      ...
      {completeModal.open && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <div className={styles.modalHeader}>
              <h3>Complete Physical Therapy Assignment</h3>
              <button
            ...
            <div className={styles.modalContent}>
              <div className={styles.confirmationMessage}>
                ...
                <p>
                  Are you sure you want to mark the Physical Therapy assignment for{" "}
