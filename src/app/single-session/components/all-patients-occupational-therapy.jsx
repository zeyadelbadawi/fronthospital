...
const AllPatientsOccupationalTherapy = () => {
  ...
  const fetchOccupationalTherapyPatients = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapyS/Occupational-therapy-assignments?${params}`,
      )
  ...
  const handleCompleteAssignment = async () => {
    ...
    try {
      const response = await axiosInstance.put(
        `${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapyS/complete-assignment/${completeModal.assignment._id}`,
  ...
  const handlePlanClick = (patientId) => {
    router.push(`/occupational-therapyS/plan/${patientId}`)
  }
    ...
    <div className={styles.upcomingContainer}>
      ...
      {completeModal.open && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <div className={styles.modalHeader}>
              <h3>Complete Occupational Therapy Assignment</h3>
              <button
            ...
            <div className={styles.modalContent}>
              <div className={styles.confirmationMessage}>
                ...
                <p>
                  Are you sure you want to mark the Occupational Therapy assignment for{" "}
