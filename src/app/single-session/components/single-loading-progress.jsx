...
import styles from "../styles/single-loading-progress.module.css"

export function SingleLoadingProgress({ onComplete }) {
  const [progress, setProgress] = useState(0)
  const [currentStep, setCurrentStep] = useState("")

  useEffect(() => {
    const steps = [
      { step: "Initializing Single Evaluation System...", duration: 300, progress: 15 },
      { step: "Verifying Medical Credentials...", duration: 400, progress: 30 },
      { step: "Loading Student Database...", duration: 350, progress: 45 },
    ...
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <div className={styles.logoContainer}>
          ...
          <h1 className={styles.title}>Single Sessions System</h1>
          <p className={styles.subtitle}>Rukn Elwatekon Center</p>
        </div>
