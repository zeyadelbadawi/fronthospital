...
const AssignPatientsToOccupationalTherapy = () => {
  ...
  const fetchAssignedPatients = async () => {
    try {
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapy/Occupational-therapy-assignments`,
      )
  ...
  const handleUnassignPatient = async (patientId) => {
    try {
      await axiosInstance.delete(
        `${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapy/unassign-from-Occupational/${patientId}`,
      )
    ...
    <div className={styles.assignPatientsContainer}>
      <div className={styles.assignPatientsCard}>
        <div className={styles.cardHeader}>
          ...
          <button onClick={() => router.push("/Occupational-therapy/patients")} className={styles.primaryButton}>
