...
const PLAN_CONFIGS = {
  aba: {
    ...
    defaultFileName: "ABA-plan-default.docx",
  ...
  speech: {
    ...
    defaultFileName: "Speech-plan-default.docx",
  ...
  "physical-therapy": {
    ...
    defaultFileName: "Physical-therapy-plan-default.docx",
  ...
  "occupational-therapy": {
    ...
    defaultFileName: "Occupational-therapy-plan-default.docx",
  ...
  "special-education": {
    ...
    defaultFileName: "Special-education-plan-default.docx",
        ...
        <div className={styles.studentInfoContainer}>
          <div className={styles.studentInfoCard}>
            ...
            <div className={styles.studentInfoGrid}>
              ...
              <div className={styles.studentInfoItem}>
                <Hash className={styles.studentInfoIcon} />
                <div className={styles.studentInfoContent}>
                  <span className={styles.studentInfoLabel}>Student ID</span>
                  <span className={styles.studentInfoValue}>{patient._id}</span>
                </div>
              </div>
              {patient.email && (
                <div className={styles.studentInfoItem}>
              ...
              {patient.phone && (
                <div className={styles.studentInfoItem}>
                  ...
                  <div className={styles.studentInfoContent}>
                    <span className={styles.studentInfoLabel}>Phone</span>
