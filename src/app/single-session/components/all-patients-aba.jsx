  ...
  const fetchabaPatients = async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/abaS/ABA-assignments?page=${currentPage}&search=${search}`,
      )
        ...
        <div className={styles.cardHeader}>
          <div className={styles.headerContent}>
            <div className={styles.headerLeft}>
              ...
              <h2 className={styles.pageTitle}>Single Sessions ABA Students</h2>
            </div>
                    ...
                    <tr key={assignment._id || index} className={styles.tableRow}>
                      ...
                      <td className={styles.actionsCell}>
                        <div className={styles.actionButtons}>
                          <button
                          onClick={() => router.push(`/ABAS/plan/${assignment.patient?._id}`)}
