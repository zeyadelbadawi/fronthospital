  ...
  const fetchspeechPatients = async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/speechS/Speech-assignments?page=${currentPage}&search=${search}`,
      )
        ...
        <div className={styles.cardHeader}>
          <div className={styles.headerContent}>
            <div className={styles.headerLeft}>
              ...
              <h2 className={styles.pageTitle}>Single Sessions speech Students</h2>
            </div>
          ...
          {loading ? (
            ...
            <div className={styles.noData}>
              <div className={styles.emptyState}>
                ...
                <h3>No speech Students Found</h3>
                <p>
                  {search
                    ? "No Students match your search criteria. Try adjusting your search terms."
                    : "No Students are currently assigned to the speech department."}
                </p>
              </div>
            </div>
          ) : (
                    ...
                    <tr key={assignment._id || index} className={styles.tableRow}>
                      ...
                      <td className={styles.actionsCell}>
                        <div className={styles.actionButtons}>
                          <button
                          onClick={() => router.push(`/speechS/plan/${assignment.patient?._id}`)}
