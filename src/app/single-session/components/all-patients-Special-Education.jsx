...
const AllPatientsSpecialEducation = () => {
  ...
  const fetchSpecialEducationPatients = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/SpecialEducationS/Special-Education-assignments?${params}`,
      )
  ...
  const handleCompleteAssignment = async () => {
    ...
    try {
      const response = await axiosInstance.put(
        `${process.env.NEXT_PUBLIC_API_URL}/SpecialEducationS/complete-assignment/${completeModal.assignment._id}`,
  ...
  const handlePlanClick = (patientId) => {
    router.push(`/Special-EducationS/plan/${patientId}`)
  }
    ...
    <div className={styles.upcomingContainer}>
        ...
        <div className={styles.cardHeader}>
          <div className={styles.headerContent}>
            <div className={styles.headerLeft}>
              ...
              <h2 className={styles.pageTitle}>Special Education Students</h2>
              <p className={styles.pageSubtitle}>Manage and view all students assigned to Special Education</p>
            </div>
      ...
      {completeModal.open && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <div className={styles.modalHeader}>
              <h3>Complete Special Education Assignment</h3>
              <button
            ...
            <div className={styles.modalContent}>
              <div className={styles.confirmationMessage}>
                ...
                <p>
                  Are you sure you want to mark the Special Education assignment for{" "}
