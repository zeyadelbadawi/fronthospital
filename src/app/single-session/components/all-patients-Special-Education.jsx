  ...
  const fetchSpecialEducationPatients = async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/SpecialEducation/Special-Education-assignments?page=${currentPage}&search=${search}`,
      )
      ...
      console.error("Error fetching SpecialEducation patients:", error)
      setAssignments([])
    } finally {
      setLoading(false)
    }
        ...
        <div className={styles.cardBody}>
          ...
          <div className={styles.paginationContainer}>
            <span className={styles.paginationInfo}>
              Showing {assignments.length} Special Education department patients
            </span>
