  ...
  const fetchSpeechPatients = async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `/speech/Speech-assignments?page=${currentPage}&search=${search}`,
      )
  ...
  return (
    <div className="card h-100 p-0 radius-12">
      <div className="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center flex-wrap gap-3 justify-content-between">
        ...
        <button
          onClick={() => router.push("/speech/assign-patients")}
      ...
      <div className="card-body p-24">
        {loading ? (
          ...
          <div className="text-center py-4">
            <p className="text-muted">No patients assigned to Speech</p>
            <button onClick={() => router.push("/speech/assign-patients")} className="btn btn-primary mt-2">
              Assign Patients
            </button>
          </div>
        ) : (
                  ...
                  <tr key={assignment._id || index}>
                    ...
                    <td className="text-center">
                      <div className="d-flex align-items-center gap-10 justify-content-center">
                        <button
                          onClick={() => router.push(`/speech/plan/${assignment.patient?._id}`)}
                          type="button"
                        ...
                        <button
                          onClick={() => router.push(`/speech/test/${assignment.patient?._id}`)}
                          type="button"
