...
const PatientPlanEditor = () => {
  ...
  const fetchExistingPlan = async () => {
    try {
      const response = await axiosInstance.get(`${process.env.NEXT_PUBLIC_API_URL}/speechS/plan/${patientId}`)
      ...
      <div className={styles.planEditorCard}>
        ...
        <SyncfusionDocx
                            userData={{
                              ...
                              }/uploads/SpeechS/plan/${
                                plan.filePath || "speech-plan-defoult.docx"
                              }`,
                              fileName:
                                plan.fileName || "speech-plan-defoult.docx",
                              docxName: `Single-Session-Speech-plan-${patient.name}.docx`,
                            }}
                            planEndpoint={`${process.env.NEXT_PUBLIC_API_URL}/speechS/upload-plan`}
                          />
            </div>
