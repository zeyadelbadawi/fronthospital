...
const PatientExamEditor = () => {
  ...
  const fetchExistingExam = async () => {
    try {
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/physicalTherapy/exam/${patientId}`
      );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.post(
        `${process.env.NEXT_PUBLIC_API_URL}/physicalTherapy/exam`,
        examData
      );
                ...
                <div className="col-12 ">
                  ...
                  <SyncfusionDocx
                    userData={{
                      ...
                      }/uploads/physical-therapy/exam/${
                        exam.filePath || "physical-therapy-exam-defoult.docx"
                      }`,
                      fileName:
