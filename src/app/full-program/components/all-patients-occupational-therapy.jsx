  ...
  const fetchOccupationalTherapyPatients = async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapy/Occupational-therapy-assignments?page=${currentPage}&search=${search}`,
      )
        ...
        <div className={styles.cardHeader}>
          <div className={styles.headerContent}>
            <div className={styles.headerLeft}>
              ...
              <h2 className={styles.pageTitle}>Occupational Therapy Department Patients</h2>
            </div>
        ...
        <div className={styles.cardBody}>
          {loading ? (
            <div className={styles.loadingContainer}>
              ...
              <p className={styles.loadingText}>Loading Occupational Therapy patients...</p>
            </div>
              ...
              <div className={styles.emptyState}>
                ...
                <p>
                  {search
                    ...
                    : "No patients are currently assigned to the Occupational Therapy department."}
                </p>
              </div>
            </div>
          ) : (
