...
const AllPatientsOccupationalTherapy = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log("Fetching OccupationalTherapy patients from PatientOccupationalTherapyAssignment...")
      ...
      try {
        ...
        setMessage("Failed to fetch ABOccupationalTherapyA patients: " + (error.response?.data?.message || error.message))
          ...
          <div className={styles.headerContent}>
            <div className={styles.titleSection}>
              <h1 className={styles.pageTitle}>
                ...
                Occupational Therapy Assignments Table
              </h1>
              <p className={styles.pageSubtitle}>View and manage Occupational Therapy patient assignments to doctors</p>
            </div>
          ...
          <div className={styles.filtersContainer} style={{ marginTop: "2rem" }}>
            <div className={styles.searchForm}>
              <div className={styles.searchInputContainer}>
                ...
                <input
                  type="text"
                  placeholder="Search Occupational Therapy patients by name, email, or patient ID..."
                  value={searchTerm}
        ...
        <div className={styles.cardBody}>
          <div style={{ marginBottom: "2rem" }}>
            ...
            >
              ...
              Occupational Therapy Patients & Doctor Assignments
            </h2>
            <div
              style={{
                height: "2px",
          ...
          {filteredPatients.length === 0 ? (
            <div className={styles.emptyState}>
              ...
              <h3>No Occupational Therapy patients found</h3>
              <p>
                {searchTerm
                  ? "No patients match your search criteria. Try adjusting your search terms."
                  : "Patients need to be assigned to the Occupational Therapy department first through PatientOccupationalTherapyAssignment."}
              </p>
            </div>
          ) : (
            <>
                    ...
                    <tr>
                      ...
                      <th>
                        <div className={styles.headerCell}>
                          ...
                          Occupational Therapy Assignment Date
                        </div>
                      </th>
                      <th>
                        <div className={styles.headerCell}>
  ...
  <span
    ...
    style={{
      fontSize: "0.875rem",
      padding: "0.25rem",
      backgroundColor: "transparent", // To remove the background styling of input
      border: "none", // To remove the border of the input
    }}
  >
