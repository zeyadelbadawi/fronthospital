...
import ExistingPhysicalPlansView from "./existing-physical-plans-view"

// Form validation schema for physicalTherapy
...
export default function DocxUploadFormPhysicalPlanPrevious({ onSuccess, onClose, defaultValues, onSwitchForm }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const existingPlanCheck = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/physicalTherapy/get-plans/${data.patientId}?quarter=${data.quarterOfYear}&year=${data.year}`,
      )
      ...
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/physicalTherapy/upload-plan`, formData, {
        headers: {
        ...
        <div className={styles.buttonGroup}>
          ...
          >
            {isSubmitting ? (
              ...
              "Upload Previous physical Therapy Plan"
            )}
          </button>
          <button
            type="button"
