...
import ExistingOccupationalExamsView from "./existing-occupational-exams-view"

// Form validation schema for occupational
...
export default function DocxUploadFormOccupationalExamPrevious({ onSuccess, onClose, defaultValues, onSwitchForm }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const existingExamCheck = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapy/get-exams/${data.patientId}?quarter=${data.quarterOfYear}&year=${data.year}`,
      )
      ...
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapy/upload-exam`, formData, {
        headers: {
        ...
        <div className={styles.buttonGroup}>
          ...
          >
            {isSubmitting ? (
              ...
              "Upload Previous Occupational Therapy Exam"
            )}
          </button>
          <button
            type="button"
