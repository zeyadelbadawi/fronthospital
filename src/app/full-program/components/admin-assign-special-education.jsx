...
const AdminAssignSpecialEducation = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch SpecialEducation patients from PatientSpecialEducationAssignment collection
      console.log("Fetching SpecialEducation patients from PatientSpecialEducationAssignment...")
      let patientsResponse
      try {
        patientsResponse = await axiosInstance.get("/SpecialEducation/patient-assignments", {
          params: { page: 1, search: "" },
        })
        console.log("Special Education patients response:", patientsResponse.data)
      } catch (error) {
        console.error("Special Education patients fetch failed:", error)
        setMessage("Failed to fetch Special Education patients: " + (error.response?.data?.message || error.message))
        patientsResponse = { data: { assignments: [], patients: [] } }
      }

      // Fetch doctors in SpecialEducation department
      console.log("Fetching Special Education doctors...")
      let doctorsResponse
      try {
        doctorsResponse = await axiosInstance.get("/doctor-student-assignment/doctors-by-department/SpecialEducation")
        console.log("Special Education doctors response:", doctorsResponse.data)
      } catch (error) {
      ...
      // Fetch current doctor-student assignments for SpecialEducation department
      console.log("Fetching SpecialEducation doctor-student assignments...")
      let assignmentsResponse
      try {
        assignmentsResponse = await axiosInstance.get("/doctor-student-assignment/all-assignments", {
          params: { department: "SpecialEducation", page: 1, limit: 100 },
        })
        console.log("SpecialEducation assignments response:", assignmentsResponse.data)
      } catch (error) {
      ...
      // Set the data - patients from PatientSpecialEducationAssignment
      ...
      setDebugInfo(
        `Loaded: ${totalPatients} Special Education patients, ${totalDoctors} doctors, ${assignedPatients} doctor assignments`,
      )

      if (doctorsData.length === 0) {
        setMessage(
          "No doctors found in Special Education department. Please ensure doctors are properly assigned to the Special Education department.",
        )
      }

      if (patientsData.length === 0) {
        setMessage(
          "No patients found in Special Education assignments. Please ensure patients are assigned to the Special Education department first.",
        )
      }
    } catch (error) {
  ...
  if (loading && patients.length === 0) {
    return (
      <div className={styles.loadingContainer}>
        ...
        <p className={styles.loadingText}>Loading SpecialEducation assignments...</p>
          ...
          <div className={styles.cardHeader}>
            <div className={styles.headerContent}>
              <div className={styles.titleSection}>
                <h2 className={styles.pageTitle}>
                  ...
                  SpecialEducation Department - Admin Assignment
                </h2>
                <p className={styles.pageSubtitle}>Assign SpecialEducation students to doctors and manage subscriptions</p>
              </div>
            ...
            <div className={styles.statsContainer}>
              <div className={styles.statItem}>
                ...
                <div className={styles.statLabel}>Total SpecialEducation Patients</div>
              </div>
              <div className={styles.statItem}>
          ...
          <div className={styles.cardBody}>
            <div style={{ marginBottom: "2rem" }}>
              ...
              >
                ...
                Assign Special Education Student to Doctor
              </h2>
              <div
                style={{
                  height: "2px",
            ...
            <form onSubmit={handleAssignStudent} className={styles.editForm}>
              <div className={styles.formGrid}>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel}>
                    ...
                    Select Special Education Patient *
                  </label>
                  <select
                    ...
                    required
                  >
                    <option value="">Choose an unassigned Special Education patient...</option>
                  ...
                  <p style={{ fontSize: "0.75rem", color: "#64748b", marginTop: "0.25rem", fontWeight: "500" }}>
                    📊 Unassigned Special Education patients: {getUnassignedPatients().length} / {patients.length}
                  </p>
                </div>
                ...
                <div className={styles.formGroup}>
                  <label className={styles.formLabel}>
                    ...
                    Select Special Education Doctor *
                  </label>
                  <select
                    ...
                    required
                  >
                    <option value="">Choose an Special Education doctor...</option>
                    {doctors.map((doctor) => (
                  ...
                  <p style={{ fontSize: "0.75rem", color: "#64748b", marginTop: "0.25rem", fontWeight: "500" }}>
                    👨‍⚕️ Available Special Education doctors: {doctors.length}
                  </p>
                </div>
              ...
              >
                ...
                >
                  ...
                  {isSubmitting ? "Assigning..." : "Assign Special Education Student to Doctor"}
                </button>
              </div>
            </form>
          </div>
...
export default AdminAssignSpecialEducation
