...
// Form validation schema for speech Exam
...
export default function CloseQuarterFormSpeechExam({ onSuccess, onClose, defaultValues = {} }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/speech/close-and-generate-next-exam`, {
