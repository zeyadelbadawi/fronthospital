...
const AssignPatientsToOccupationalTherapy = () => {
  ...
  const handleAssignPatient = async (patientId) => {
    ...
    try {
      ...
      alert("Student assigned to Occupational-therapy department successfully!")
    } catch (error) {
      console.error("Error assigning Student:", error)
      alert("Error assigning Student to Occupational-therapy department")
    }
  }
  ...
  const handleUnassignPatient = async (patientId) => {
    try {
      ...
      alert("Student unassigned from Occupational therapy department successfully!")
    } catch (error) {
      console.error("Error unassigning Student:", error)
      alert("Error unassigning Student from Occupational therapy department")
    }
  }
        ...
        <div className={styles.cardHeader}>
          <div className={styles.headerContent}>
            <div className={styles.headerLeft}>
              ...
              <h2 className={styles.pageTitle}>Assign Students to Occupational therapy Department</h2>
            </div>
