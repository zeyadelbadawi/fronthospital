...
export default function CloseQuarterFormSpeech({ onSuccess, onClose, defaultValues = {} }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/speech/close-and-generate-next-plan`, {
