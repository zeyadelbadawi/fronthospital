...
export default function DocxUploadFormOccupational({ onSuccess, onClose, defaultValues }) {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={styles.uploadForm}>
          ...
          <div className="row">
            <div className="col-md-6">
              <div className={styles.formColumn}>
                ...
                />
                {/* The actual patientId is still passed via formData in onSubmit, so no need for Controller here */}
              </div>
            </div>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <select
                      ...
                      disabled={true} // Made unchangeable
                    >
        ...
        >
          {isSubmitting ? (
            ...
            "Upload Occupational Therapy Plan"
          )}
        </button>
      </form>
    </div>
