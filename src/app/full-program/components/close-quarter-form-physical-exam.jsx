...
// Form validation schema for physical Exam
...
export default function CloseQuarterFormPhysicalExam({ onSuccess, onClose, defaultValues = {} }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/physicalTherapy/close-and-generate-next-exam`, {
