...
const AllPatients = ({ contentType }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log(`Fetching ${department.displayName} patients from Patient${department.name}Assignment...`)
      let patientsResponse
      try {
        patientsResponse = await axiosInstance.get(`${department.apiEndpoint}/patient-assignments`, {
          params: { page: currentPage, search: searchTerm },
        })
        console.log(`${department.displayName} patients response:`, patientsResponse.data)
      } catch (error) {
        console.error(`${department.displayName} patients fetch failed:`, error)
        setMessage(
          `Failed to fetch ${department.displayName} patients: ` + (error.response?.data?.message || error.message),
        )
          ...
          <div className={styles.headerContent}>
            <div className={styles.titleSection}>
              ...
              <p className={styles.pageSubtitle}>
                View and manage {department.displayName} patient assignments to doctors
              </p>
            </div>
          ...
          <div className={styles.filtersContainer} style={{ marginTop: "2rem" }}>
            <div className={styles.searchForm}>
              <div className={styles.searchInputContainer}>
                ...
                <input
                  type="text"
                  placeholder={`Search ${department.displayName} patients by name, email, or patient ID...`}
                  value={searchTerm}
        ...
        <div className={styles.cardBody}>
          <div style={{ marginBottom: "2rem" }}>
            ...
            >
              ...
              {department.displayName} Patients & Doctor Assignments
            </h2>
            <div
              style={{
                height: "2px",
          ...
          {filteredPatients.length === 0 ? (
            <div className={styles.emptyState}>
              ...
              <h3>No {department.displayName} patients found</h3>
              <p>
                {searchTerm
                  ? "No patients match your search criteria. Try adjusting your search terms."
                  : `Patients need to be assigned to the ${department.displayName} department first through Patient${department.name}Assignment.`}
              </p>
            </div>
          ) : (
            <>
