  ...
  if (loading && assignments.length === 0) {
    return (
      <div className={styles.loadingContainer}>
        ...
        <p className={styles.loadingText}>Loading your Occupational Therapy students...</p>
      </div>
    )
  }
          ...
          <div className={styles.headerContent}>
            <div className={styles.titleSection}>
              <h1 className={styles.pageTitle}>
                ...
                My Occupational Therapy Students
              </h1>
            ...
            <div className={styles.emptyState}>
              ...
              <p>
                {searchTerm
                  ...
                  : "You don't have any Occupational Therapy students assigned to you yet."}
              </p>
            </div>
          ) : (
            <>
