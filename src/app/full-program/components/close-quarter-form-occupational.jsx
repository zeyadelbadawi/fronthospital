...
export default function CloseQuarterFormOccupationalTherapy({ onSuccess, onClose, defaultValues = {} }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapy/close-and-generate-next-plan`, {
