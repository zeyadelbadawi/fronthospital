...
import DocxUploadFormOccupationalExam from "./docx-upload-form-occupational-exam"
import DocxUploadFormOccupationalExamPrevious from "./docx-upload-form-occupational-exam-previous" // New import
import CloseQuarterFormOccupationalExam from "./close-quarter-form-occupational-exam"
...
export default function OccupationalExamView({ patientId, onBack }) {
  ...
  const department = "OccupationalTherapy"
  ...
  const determineActiveQuarter = async () => {
    ...
    try {
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapy/get-exams/${patientId}?last=true`,
      )
  ...
  const fetchAllHistoricalExams = useCallback(async () => {
    ...
    setError(null)
    try {
      const response = await axiosInstance.get(`${process.env.NEXT_PUBLIC_API_URL}/OccupationalTherapy/exams/${patientId}`)
  ...
  const handleSaveContent = async (documentContentBlob) => {
    ...
    try {
      ...
      formData.append("title", selectedExam.title || `Occupational Therapy Exam for ${patient?.name || patientId}`)

      const response = await axiosInstance.put(
        `${process.env.NEXT_PUBLIC_API_URL}/${department}/exam/${selectedExam._id}`,
        formData,
        {
            ...
            <div className={styles.planEditorCard}>
                ...
                <div className={styles.headerBottomRow}>
                  <div className={styles.studentInfo}>
                    <h3 className={styles.planTitle}>
                      ...
                      <span>Occupational Therapy Exam for</span>
              ...
              <div className={styles.planBody}>
                <SyncfusionDocx
                  ...
                  docxName={`${selectedExam.title || "Occupational Therapy-exam"}-${patient?.name || patientId}-Q${selectedExam.quarterOfYear}-${selectedExam.year}`}
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered">
              <div className={`modal-content ${styles.modalContent}`}>
                ...
                <div className="modal-body p-0">
                  <DocxUploadFormOccupationalExam
        ...
        {isUploadPreviousModalOpen && ( // Modal for previous exam upload
          <div className={styles.modalOverlay}>
            <div className="modal-dialog modal-lg modal-dialog-centered">
              <div className={`modal-content ${styles.modalContent}`}>
                <div className="modal-header">
                  <h5 className="modal-title">Upload Previous Occupational Therapy Exam</h5>
                  <button
                    type="button"
                    className="btn-close"
                ...
                <div className="modal-body p-0">
                  <DocxUploadFormOccupationalExamPrevious
                    onSuccess={handleUploadSuccess}
          ...
          <div className={styles.modalOverlay}>
            <div className="modal-dialog modal-lg modal-dialog-centered">
              <div className={`modal-content ${styles.modalContent}`}>
                ...
                <div className="modal-body p-0">
                  <CloseQuarterFormOccupationalExam
