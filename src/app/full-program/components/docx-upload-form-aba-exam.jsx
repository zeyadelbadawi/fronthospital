...
export default function DocxUploadFormABAExam({ onSuccess, onClose, defaultValues }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const existingExamCheck = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/aba/get-exams/${data.patientId}?quarter=${data.quarterOfYear}&year=${data.year}`,
      )
      ...
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/aba/upload-exam`, formData, {
        headers: {
