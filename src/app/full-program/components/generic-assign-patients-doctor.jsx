...
const DEPARTMENT_CONFIG = {
  aba: {
    ...
    displayName: "ABA",
    fullName: "ABA",
    title: "My ABA Students",
    subtitle: "Manage and view your assigned ABA students",
    loadingText: "Loading your ABA students...",
    emptyText: "You don't have any ABA students assigned to you yet.",
  },
  speech: {
    endpoint: "speech",
    displayName: "Speech",
    fullName: "Speech Therapy",
    title: "My Speech Students",
    subtitle: "Manage and view your assigned Speech students",
    loadingText: "Loading your Speech students...",
    emptyText: "You don't have any Speech students assigned to you yet.",
  },
  physical: {
    endpoint: "physicalTherapy",
    displayName: "Physical Therapy",
    fullName: "Physical Therapy",
    title: "My Physical Therapy Students",
    subtitle: "Manage and view your assigned Physical Therapy students",
    loadingText: "Loading your Physical Therapy students...",
    emptyText: "You don't have any Physical Therapy students assigned to you yet.",
  },
  occupational: {
    endpoint: "OccupationalTherapy",
    displayName: "Occupational Therapy",
    fullName: "Occupational Therapy",
    title: "My Occupational Therapy Students",
    subtitle: "Manage and view your assigned Occupational Therapy students",
    loadingText: "Loading your Occupational Therapy students...",
    emptyText: "You don't have any Occupational Therapy students assigned to you yet.",
  },
  special: {
    endpoint: "SpecialEducation",
    displayName: "Special Education",
    fullName: "Special Education",
    title: "My Special Education Students",
    subtitle: "Manage and view your assigned Special Education students",
...
export default function GenericAssignPatientsDoctor({ department, onViewPlan, onViewExam }) {
    ...
    try {
      ...
      try {
        response = await axiosInstance.get(
          `/doctor-student-assignment/doctor-students/${doctorId}/${config.endpoint}`,
          {
  ...
  const handlePlanClick = (patientId) => {
    ...
    if (onViewPlan) {
      ...
      console.warn(`onViewPlan prop is not provided to GenericAssignPatientsDoctor for ${department}.`)
    }
  }
  ...
  const handleExamClick = (patientId) => {
    ...
    if (onViewExam) {
      ...
      console.warn(`onViewExam prop is not provided to GenericAssignPatientsDoctor for ${department}.`)
    }
  }
            ...
            <div className={styles.headerActions}>
              ...
              {department === "aba" && (
                <button
                  ...
                  title="Manual Subscription Check"
                >
                  <RefreshCw className={`${styles.refreshIcon} ${isCheckingSubscriptions ? styles.spinning : ""}`} />
          ...
          <div className={styles.cardBody}>
            <div
              style={{
                ...
                padding: "1rem",
                borderRadius: "0.75rem",
                backgroundColor: subscriptionCheckError ? "#fee2e2" : "#d1fae5",
                color: subscriptionCheckError ? "#dc2626" : "#065f46",
                border: subscriptionCheckError ? "1px solid #fecaca" : "1px solid #a7f3d0",
                display: "flex",
                alignItems: "center",
                boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1)",
              }}
            >
              <AlertCircle style={{ marginRight: "0.75rem", flexShrink: 0 }} size={20} />
              <span style={{ fontWeight: "500" }}>{subscriptionCheckMessage}</span>
            </div>
          </div>
        )}
...
export function AssignPatientsSpeechDoctor({ onViewSpeechPlan, onViewSpeechExam }) {
  return <GenericAssignPatientsDoctor department="speech" onViewPlan={onViewSpeechPlan} onViewExam={onViewSpeechExam} />
}

export function AssignPatientsPhysicalTherapyDoctor({ onViewPhysicalPlan, onViewPhysicalExam }) {
  return (
...
export function AssignPatientsOccupationalTherapyDoctor({ onViewoccupationalPlan, onViewoccupationalExam }) {
  return (
    <GenericAssignPatientsDoctor
      department="occupational"
      onViewPlan={onViewoccupationalPlan}
      onViewExam={onViewoccupationalExam}
    />
  )
}

export function AssignPatientsSpecialEducationDoctor({ onViewSpecialPlan, onViewSpecialExam }) {
  return (
    <GenericAssignPatientsDoctor department="special" onViewPlan={onViewSpecialPlan} onViewExam={onViewSpecialExam} />
  )
}
