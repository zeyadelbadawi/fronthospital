...
export default function DocxUploadFormPhysicalExam({ onSuccess, onClose, defaultValues }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const existingExamCheck = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/physicalTherapy/get-exams/${data.patientId}?quarter=${data.quarterOfYear}&year=${data.year}`,
      )
      ...
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/physicalTherapy/upload-exam`, formData, {
        headers: {
