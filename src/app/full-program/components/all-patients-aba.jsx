          ...
          <div className={styles.headerContent}>
            <div className={styles.titleSection}>
              <h1 className={styles.pageTitle}>
                ...
                ABA Assignments Table
              </h1>
              <p className={styles.pageSubtitle}>View and manage ABA patient assignments to doctors</p>
            </div>
          ...
          <div className={styles.filtersContainer} style={{ marginTop: "2rem" }}>
            <div className={styles.searchForm}>
              <div className={styles.searchInputContainer}>
                ...
                <input
                  type="text"
                  placeholder="Search ABA patients by name, email, or patient ID..."
                  value={searchTerm}
        ...
        <div className={styles.cardBody}>
          <div style={{ marginBottom: "2rem" }}>
            ...
            >
              ...
              ABA Patients & Doctor Assignments
            </h2>
            <div
              style={{
                height: "2px",
          ...
          {filteredPatients.length === 0 ? (
            <div className={styles.emptyState}>
              ...
              <h3>No ABA patients found</h3>
              <p>
                {searchTerm
                  ? "No patients match your search criteria. Try adjusting your search terms."
                  : "Patients need to be assigned to the ABA department first through PatientABAAssignment."}
              </p>
            </div>
          ) : (
            <>
