...
const AllPatientsPhysicalTherapy = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch physicalTherapy patients from PatientSpecialEducationAssignment collection
      console.log("Fetching physicalTherapy patients from PatientSpecialEducationAssignment...")
      ...
      console.log("Fetching physicalTherapy doctor-student assignments...")
          ...
          <div className={styles.headerContent}>
            <div className={styles.titleSection}>
              <h1 className={styles.pageTitle}>
                ...
                physical Therapy Assignments Table
              </h1>
              <p className={styles.pageSubtitle}>View and manage physical Therapy patient assignments to doctors</p>
            </div>
          ...
          <div className={styles.filtersContainer} style={{ marginTop: "2rem" }}>
            <div className={styles.searchForm}>
              <div className={styles.searchInputContainer}>
                ...
                <input
                  type="text"
                  placeholder="Search physical Therapy patients by name, email, or patient ID..."
                  value={searchTerm}
        ...
        <div className={styles.cardBody}>
          <div style={{ marginBottom: "2rem" }}>
            ...
            >
             ...
             physical Therapy Patients & Doctor Assignments
            </h2>
            <div
              style={{
                height: "2px",
          ...
          {filteredPatients.length === 0 ? (
            <div className={styles.emptyState}>
              ...
              <h3>No physical Therapy patients found</h3>
              <p>
                {searchTerm
                  ? "No patients match your search criteria. Try adjusting your search terms."
                  : "Patients need to be assigned to the physical Therapy department first through PatientSpecialEducationAssignment."}
              </p>
            </div>
          ) : (
            <>
                    ...
                    <tr>
                      ...
                      <th>
                        <div className={styles.headerCell}>
                          ...
                          physical Therapy Assignment Date
                        </div>
                      </th>
                      <th>
                        <div className={styles.headerCell}>
