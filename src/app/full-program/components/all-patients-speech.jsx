...
const AllPatientsSpeech = () => {
  ...
  const fetchspeechPatients = async () => {
    ...
    try {
      ...
      console.error("Error fetching speech therapy Students:", error)
      setAssignments([])
    } finally {
      setLoading(false)
    }
        ...
        <div className={styles.cardHeader}>
          <div className={styles.headerContent}>
            <div className={styles.headerLeft}>
              ...
              <h2 className={styles.pageTitle}>speech Department Students</h2>
            </div>
        ...
        <div className={styles.cardBody}>
          {loading ? (
            <div className={styles.loadingContainer}>
              ...
              <p className={styles.loadingText}>Loading speech Students...</p>
            </div>
