          ...
          <div className={styles.headerContent}>
            <div className={styles.titleSection}>
              <h1 className={styles.pageTitle}>
                ...
                speech Assignments Table
              </h1>
              <p className={styles.pageSubtitle}>View and manage speech patient assignments to doctors</p>
            </div>
          ...
          <div className={styles.filtersContainer} style={{ marginTop: "2rem" }}>
            <div className={styles.searchForm}>
              <div className={styles.searchInputContainer}>
                ...
                <input
                  type="text"
                  placeholder="Search speech patients by name, email, or patient ID..."
                  value={searchTerm}
        ...
        <div className={styles.cardBody}>
          <div style={{ marginBottom: "2rem" }}>
            ...
            >
              ...
              speech Patients & Doctor Assignments
            </h2>
            <div
              style={{
                height: "2px",
            ...
            <div className={styles.emptyState}>
              ...
              <p>
                {searchTerm
                  ...
                  : "Patients need to be assigned to the speech department first through PatientspeechAssignment."}
              </p>
            </div>
          ) : (
            <>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className={styles.dateCell}>
                            {doctorAssignment ? (
                              <div style={{ display: "flex", alignItems: "center" }}>
                                ...
                                <span
                                  className={`${styles.formInput} ${isExpired ? "border-red-300 bg-red-50" : "border-gray-300"
                                    }`}
                                  style={{
                                    fontSize: "0.875rem",
                                    padding: "0.25rem",
                          ...
                          <td className={styles.typeCell}>
                            {doctorAssignment ? (
                              <span
                                className={`${styles.typeBadge} ${isExpired
                                    ? styles.assessment
            ...
            <div className={styles.modalBody}>
              <div className={styles.detailsGrid}>
                ...
                <div className={styles.detailItem}>
                  ...
                  <div className={styles.detailValue}>
                    <span
                      className={`${styles.typeBadge} ${isSubscriptionExpired(selectedAssignment.subscriptionEndDate)
                          ? styles.assessment
