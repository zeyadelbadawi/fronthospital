...
// Form validation schema for ABA Exam
...
export default function CloseQuarterFormABAExam({ onSuccess, onClose, defaultValues = {} }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/aba/close-and-generate-next-exam`, {
