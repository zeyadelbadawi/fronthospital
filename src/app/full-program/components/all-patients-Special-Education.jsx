  ...
  const fetchData = async () => {
    try {
      ...
      try {
        ...
        console.log("SpecialEducation patients response:", patientsResponse.data)
      } catch (error) {
        console.error("SpecialEducation patients fetch failed:", error)
        setMessage("Failed to fetch SpecialEducation patients: " + (error.response?.data?.message || error.message))
        patientsResponse = { data: { assignments: [], patients: [] } }
      }

      // Fetch doctors in SpecialEducation department
      console.log("Fetching SpecialEducation doctors...")
      let doctorsResponse
      try {
        doctorsResponse = await axiosInstance.get("/doctor-student-assignment/doctors-by-department/SpecialEducation")
        console.log("SpecialEducation doctors response:", doctorsResponse.data)
      } catch (error) {
  ...
  if (loading && patients.length === 0) {
    return (
      <div className={styles.loadingContainer}>
        ...
        <p className={styles.loadingText}>Loading Special Education assignments...</p>
      </div>
    )
  }
        ...
        <div className={styles.cardHeader}>
          <div className={styles.headerContent}>
            <div className={styles.titleSection}>
              <h3 className={styles.pageTitle}>
                ...
                Special Education Assignments Table
              </h3>
              <p className={styles.pageSubtitle}>View and manage Special Education patient assignments to doctors</p>
            </div>
          ...
          <div className={styles.statsContainer}>
            <div className={styles.statItem}>
              ...
              <div className={styles.statLabel}>Total Special Education Patients</div>
            </div>
            <div className={styles.statItem}>
          ...
          <div className={styles.filtersContainer} style={{ marginTop: "2rem" }}>
            <div className={styles.searchForm}>
              <div className={styles.searchInputContainer}>
                ...
                <input
                  type="text"
                  placeholder="Search Special Education patients by name, email, or patient ID..."
                  value={searchTerm}
        ...
        <div className={styles.cardBody}>
          <div style={{ marginBottom: "2rem" }}>
            ...
            >
             ...
             Special Education Patients & Doctor Assignments
            </h2>
            <div
              style={{
                height: "2px",
            ...
            <div className={styles.emptyState}>
              ...
              <p>
                {searchTerm
                  ...
                  : "Patients need to be assigned to the Special Education department first through PatientSpecialEducationAssignment."}
              </p>
            </div>
          ) : (
            <>
                          ...
                          <td className={styles.patientCell}>
                            <div className={styles.patientInfo}>
                              <div className={styles.patientName}>
                                {patient?.phone || "No Phone Numbers"}
                              </div>
                            </div>
                          </td>
