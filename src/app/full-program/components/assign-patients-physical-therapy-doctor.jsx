  ...
  if (loading && assignments.length === 0) {
    return (
      <div className={styles.loadingContainer}>
        ...
        <p className={styles.loadingText}>Loading your physical Therapy students...</p>
      </div>
    )
  }
            ...
            <div className={styles.emptyState}>
              ...
              <p>
                {searchTerm
                  ...
                  : "You don't have any physical Therapy students assigned to you yet."}
              </p>
            </div>
          ) : (
            <>
