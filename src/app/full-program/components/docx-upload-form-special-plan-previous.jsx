...
import ExistingSpecialPlansView from "./existing-special-plans-view"
...
export default function DocxUploadFormSpecialPlanPrevious({ onSuccess, onClose, defaultValues, onSwitchForm }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const existingPlanCheck = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/SpecialEducation/get-plans/${data.patientId}?quarter=${data.quarterOfYear}&year=${data.year}`,
      )
      ...
      const response = await axiosInstance.post(`${process.env.NEXT_PUBLIC_API_URL}/SpecialEducation/upload-plan`, formData, {
        headers: {
        ...
        <div className={styles.buttonGroup}>
          ...
          >
            {isSubmitting ? (
              ...
              "Upload Previous Special Education Plan"
            )}
          </button>
          <button
            type="button"
