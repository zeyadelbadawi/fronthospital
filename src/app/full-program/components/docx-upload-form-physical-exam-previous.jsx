...
import ExistingPhysicalExamsView from "./existing-physical-exams-view"

// Form validation schema for physical
...
export default function DocxUploadFormPhysicalExamPrevious({ onSuccess, onClose, defaultValues, onSwitchForm }) {
        ...
        <div className={styles.buttonGroup}>
          ...
          >
            {isSubmitting ? (
              ...
              "Upload Previous physicalTherapy Exam"
            )}
          </button>
          <button
            type="button"
