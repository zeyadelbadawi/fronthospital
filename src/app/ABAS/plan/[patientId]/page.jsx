...
const PatientPlanEditor = () => {
  ...
  const fetchExistingPlan = async () => {
    try {
      const response = await axiosInstance.get(
        `${process.env.NEXT_PUBLIC_API_URL}/abaS/plan/${patientId}`
      );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.post(
        `${process.env.NEXT_PUBLIC_API_URL}abaS/plan`,
        planData
      );
                  ...
                  <SyncfusionDocx
                    userData={{
                      ...
                      filePath: `${
                        ...
                        plan.filePath || "ABA-plan-defoult.docx"
                      }`,
                      fileName:
                        plan.fileName || "ABA-plan-defoult.docx",
                      docxName: `ABA-plan-${patient.name}.docx`,
                    }}
                    planEndpoint={`${process.env.NEXT_PUBLIC_API_URL}/abaS/upload-plan`}
                  />
                  {/* {plan.filePath ? (
                    <div
