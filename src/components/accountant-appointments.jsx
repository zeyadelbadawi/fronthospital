...
export function AccountantAppointments() {
  ...
  const t = {
    en: {
      ...
      messages: {
        paymentSuccess: "Payment completed successfully! Patient has been assigned to all departments.",
    ...
    ar: {
      ...
      messages: {
        paymentSuccess: "تم إكمال الدفع بنجاح! تم تعيين المريض لجميع الأقسام.",
