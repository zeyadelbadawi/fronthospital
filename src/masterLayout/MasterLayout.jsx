      ...
      >
        ...
        <div>
          <Link href="/" className="sidebar-logo">
            ...
            />
            <img src="assets/dlogo.png" alt="site logo" className="dark-logo" />
            <img src="assets/dlogo.png" alt="site logo" className="logo-icon" />
          </Link>
        </div>
          ...
          <ul className="sidebar-menu" id="sidebar-menu">
            ...
            <li>
              <Link
                ...
                className={
                  pathname === "/doctor-dashboard" ? "active-page" : ""
                }
              >
            ...
            <li>
              <Link
                ...
                className={
                  pathname === "/full-program-appointments" ? "active-page" : ""
                }
              >
                <Icon icon="bi:chat-dots" className="menu-icon" />
            ...
            <li>
              <Link
                ...
                className={
                  pathname === "/profile-dashboard" ? "active-page" : ""
                }
              >
            ...
            <li>
              <Link
                ...
                className={
                  pathname === "/doctor-dashboard2" ? "active-page" : ""
                }
              >
                <Icon
            ...
            <li>
              <Link
                ...
                className={
                  pathname === "/Payment-Transactions" ? "active-page" : ""
                }
              >
                <Icon icon="bi:chat-dots" className="menu-icon" />
            ...
            <li>
              <Link
                ...
                className={
                  pathname === "/Patient-Payments" ? "active-page" : ""
                }
              >
                <Icon icon="bi:chat-dots" className="menu-icon" />
      ...
      >
                    ...
                    <div className="max-h-400-px overflow-y-scroll scroll-sm pe-4">
                      {notifications?.map((item) => (
                        <div
                          key={item._id}
                          onClick={() => {
                            !item.isRead ? notificationClick(item._id) : null;
                          }}
                    ...
                    <div className="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                      <div>
                        <h6 className="text-lg text-primary-light fw-semibold mb-2">
                          {userName || "Loading..."}{" "}
                          {/* Use a placeholder if data is unavailable */}
                        </h6>
        ...
        <footer className="d-footer">
          <div className="row align-items-center justify-content-between">
            <div className="col-auto">
              <p className="mb-0">
                © 2025 Rukn Alwatikon Center. All Rights Reserved.
              </p>
            </div>
            <div className="col-auto">
              <p className="mb-0">
                Made by{" "}
                <span className="text-primary-600">Eng: Ziad Elbadawi</span>
              </p>
            </div>
          </div>
        </footer>
